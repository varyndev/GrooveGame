...
+ (NSData *)jsonFromAdEvent:(AMAZONAd *)aMAZONAd error:(NSError *__autoreleasing *)errorPtr;
+ (NSData *)jsonFromAdPositionEvent:(AMAZONAdPosition *)aMAZONAdPosition error:(NSError *__autoreleasing *)errorPtr;
