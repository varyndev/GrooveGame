...
+ (NSData *)jsonFromAdEvent:(AMAZONAd *)ad error:(NSError *__autoreleasing *)errorPtr {
    NSMutableDictionary* returnDictionary = [NSMutableDictionary dictionary];
    NSDictionary* ret = [ad dictionaryValue];
    if(![NSJSONSerialization isValidJSONObject:ret]) {
        if(errorPtr) {
    ...
    [returnDictionary setObject:@"adCollapsed" forKey:@"eventId"];
    return [NSJSONSerialization dataWithJSONObject:returnDictionary options:0 error:errorPtr];
}

+ (NSData *)jsonFromAdPositionEvent:(AMAZONAdPosition *)adPosition error:(NSError *__autoreleasing *)errorPtr {
    NSMutableDictionary* returnDictionary = [NSMutableDictionary dictionary];
    ...
    [returnDictionary setObject:ret forKey:@"response"];
    [returnDictionary setObject:@"adResized" forKey:@"eventId"];
    return [NSJSONSerialization dataWithJSONObject:returnDictionary options:0 error:errorPtr];
}
