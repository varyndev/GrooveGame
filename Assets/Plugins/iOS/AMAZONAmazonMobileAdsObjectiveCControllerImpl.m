...
- (void)fireAdCollapsed:(AMAZONAd *)adObject {
    NSError * jsonFromObjectError = nil;
    NSData* jsonData = [AMAZONAmazonMobileAdsJsonFromObject jsonFromAdEvent:adObject error:&jsonFromObjectError];
...
- (void)fireAdResized:(AMAZONAdPosition *)adPosition {
    NSError * jsonFromObjectError = nil;
    NSData* jsonData = [AMAZONAmazonMobileAdsJsonFromObject jsonFromAdPositionEvent:adPosition error:&jsonFromObjectError];
    if(jsonData == nil && jsonFromObjectError) {
